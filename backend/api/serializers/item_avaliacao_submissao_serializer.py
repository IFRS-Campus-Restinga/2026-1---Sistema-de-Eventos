...
class ItemAvaliacaoSubmissaoSerializer(serializers.ModelSerializer):
    nota = serializers.FloatField(required=True, min_value=0, max_value=10)

    class Meta:
        model = ItemAvaliacaoSubmissao
        fields = ["id", "nota", "criterio_avaliacao", "avaliacao_submissao"]
    ...
    def create(self, validated_data):
        ...
        instance = ItemAvaliacaoSubmissao(**validated_data)
        instance.full_clean()
        instance.save()
        return instance
